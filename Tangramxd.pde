...
Para el modo creador seria bueno */
...
void keyReleased() {
  if ((dist(posxTG1, posyTG1, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key=='a') {
  ...
  if ((dist(posxP, posyP, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key== 'a') {
      if (angleP==PI) {
        angleP=0;
      } else {
  ...
  if ((dist(posxTG2, posyTG2, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key=='a') {
  ...
  if ((dist(posxTM, posyTM, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key=='a') {
  ...
  if ((dist(posxTP1, posyTP1, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key=='a') {
  ...
  if ((dist(posxTP2, posyTP2, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key=='a') {
  ...
  if ((dist(posxC, posyC, mouseX, mouseY)<40)&&(keyPressed)) {
    if (key== 'a') {
      if (angleC==PI/2) {
        angleC=0;
      } else {
...
void GanoJuego() {
  if ((dist(posxTG1, posyTG1, 720, 550)<5 || dist(posxTG1, posyTG1, 680, 430)<5) && dist(posxP, posyP, 798, 438)<5 && (dist(posxTG2, posyTG2, 720, 550)<5 || dist(posxTG2, posyTG2, 680, 430)<5) && dist(posxC, posyC, 756, 351)<5 && dist(posxTM, posyTM, 640, 520)<5 && (dist(posxTP1, posyTP1, 820, 540)<5 || dist(posxTP1, posyTP1, 780, 500)<5) && (dist(posxTP2, posyTP2, 820, 540)<5 || dist(posxTP2, posyTP2, 780, 500)<5) ) {
    ...
    background(255);
    textSize(50);
    text("Felicidades, lo Lograste!", width/8, height/2);
  } else {
