...
void draw(){
  ...
  if (CR.accionado){
    ...
    strokeWeight(4);
    fill(255);
    quad(500,500,900,500,900,900,500,900);
    pop();
    ...
    if (accionado){
      ...
      Rx = new Creador(pos[0],pos[1],ang[0],pos[2],pos[3],ang[1],pos[4],pos[5],ang[2],pos[6],pos[7],ang[3],pos[8],pos[9],ang[4],pos[10],pos[11],
      ang[5],mir,pos[12],pos[13],ang[6]);
...
void keyReleased(){
  if(keyPressed){
    if(key=='1'){
      TG1.seleccionarF=true;
      TG2.seleccionarF=false;
      TM.seleccionarF=false;
      TP1.seleccionarF=false;
      TP2.seleccionarF=false;
      P.seleccionarF=false;
      C.seleccionarF=false;
    }

    if(key=='2'){
      TG1.seleccionarF=false;
      TG2.seleccionarF=true;
      TM.seleccionarF=false;
      TP1.seleccionarF=false;
      TP2.seleccionarF=false;
      P.seleccionarF=false;
