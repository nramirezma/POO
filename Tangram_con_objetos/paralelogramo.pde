class Paralelogramo extends Shape{
  ...
  Paralelogramo(float angle_,int posx_, int posy_,int posx1_,int posy1_,int posx2_,int posy2_,int posx3_,int posy3_,int posx4_,int posy4_,int a_,int b_,int c_){
  ...
  void display(){
   ...
   if ((dist(posx, posy, mouseX, mouseY)<20)&&(mousePressed)) {
